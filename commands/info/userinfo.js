...
module.exports = {
    data: new SlashCommandBuilder()
        ...
        .addUserOption(opt => opt.setName('العضو').setDescription('العضو المراد عرض معلوماته (اتركه فارغاً لعرض معلوماتك)').setRequired(false)),
    ...
    async execute(interaction) {
        ...
        const embed = baseEmbed()
            ...
            .addFields(
                ...
                { name: '📅 تاريخ إنشاء الحساب', value: `<t:${Math.floor(targetUser.createdTimestamp / 1000)}:D>`, inline: true },
                { name: '📥 تاريخ الانضمام للسيرفر', value: `<t:${Math.floor(targetMember.joinedTimestamp / 1000)}:D>`, inline: true },
